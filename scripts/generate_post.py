...
def generate_full_post():
    ...
    5. 고단가 키워드 배치: 제목과 본문에 금융, 보험, 법률, 투자와 관련된 키워드를 1~2%의 밀도로 자연스럽게 유지하세요.
    6. 실질적 도움: 구체적인 도구 이름, 웹사이트, 실천 수칙 등 '실질적인 정보'를 본문의 50% 이상 채우세요.
    7. 분량 확대: 한글 기준 공백 포함 2,200자 내외로 매우 깊이 있게 작성하세요. 
    8. 서사 부여: 도입부에서 독자의 상황(예: "어느 날 아침 자산 리포트를 보며 느꼈던...")에 공감하는 서사를 먼저 던지세요.
    9. 금기: '4060 세대', '중장년층' 단어 사용 금지. '사회의 중추', '지혜의 목소리' 등으로 대체.
